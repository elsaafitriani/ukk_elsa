...
<style>
  body {
    background: url('../../assets/img/bckg.png') no-repeat center center fixed;
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" style="max-width: 100%;">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="../../assets/img/perpus.jpg" class="d-block w-100 " style="height: 300px;" alt="buku.jpg">
        </div>
        <div class="carousel-item">
          <img src="../../assets/img/perpus2.jpg" class="d-block w-100 " style="height: 300px;"alt="buku2.jpg">
        </div>
        <div class="carousel-item">
          <img src="../../assets/img/perpus3.jpg" class="d-block w-100 " style="height: 300px;"alt="buku3.jpg">
        </div>
      </div>
