      ...
      <table class="table table-striped table-hover" style="text-align: center;">
        ...
        <?php
              ...
              <tr>
                ...
                <?php
                    if ($item['status'] == '0') {
                      echo '<b class="badge bg-warning style="width:140px;">Menunggu Persetujuan</b>';
                      ?>
                       <div>
                      <a href="batalPinjam.php?id=<?= $item['peminjaman_id']; ?>" class="btn btn-danger mt-2" style="width:140px;" onclick="return confirm('Apakah anda ingin membatalkan peminjaman ini?');"> Batalkan</a>
                      </div>
                      <?php
